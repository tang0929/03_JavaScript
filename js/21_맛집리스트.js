...
// 샘플 식당 데이터 추가
resList.push(new Restaurant("김밥천국","김밥, 라면","서울시 중구"));
...
/* addBtn 클릭시 input에 입력된 값을 모두 얻어와 resList에 추가 */
...
/* 유효성 검사 */
// -> 전달된 데이터가 형식, 크기, 작성법에 맞는지 검사
// ex) 입력된 값이 없을 경우, 비밀번호 형식이 맞지 않을 경우, 입력된 값의 범위가 옳지 않을 경우
