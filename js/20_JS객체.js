...
btn2.addEventListener("click",() => {
    ...
    const smartphone = [];   // 비어잇는 객체 생성

    smartphone.modelName = "아이폰15";
  ...
  smartphone.call("012-3456-7890");

  // (참고) 메서드 생성 시 하살표 함수 + this 사용
...
function Student(name, grade, ban, number, score){
    ...
    this.introduce = function(){
        console.log(`${this.grade}학년 ${this.ban}반 ${this.number}번`+ `${this.name} ${score}점`);
    }
}
